...
import br.senac.tads3.CRUDCliente.ServicoCliente;
...
@WebServlet(name = "AdicionarClienteVenda", urlPatterns = {"/AdicionarClienteVenda"})
	  ...
	  throws ServletException, IOException {
        ...
        if (request.getParameter("palavra").equals("") || request.getParameter("palavra") == null) {
            try {
                ...
                RequestDispatcher dispatcher = request.getRequestDispatcher("/WEB-INF/adicionarClienteVenda.jsp");
