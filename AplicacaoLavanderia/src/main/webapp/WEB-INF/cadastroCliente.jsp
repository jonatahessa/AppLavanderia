                ...
                <c:choose>
                    <c:when test="${erroNome}"> 
                        <div class="input-group">
                            ...
                            <input id="camponome" maxlength="50" type="text" value="${nome}" name="nome" class="form-control erro" placeholder="Nome">
                    ...
                    <c:otherwise>
                        <div class="input-group">
                            <span class="input-group-addon"><span class="fa fa-user fa-fw"></span></span>
                            <input id="camponome" maxlength="50" type="text" value="${nome}" name="nome" class="form-control" placeholder="Nome">
                            <c:if test="${trueNome}">
                ...
                <c:choose>
                    <c:when test="${erroEmail}">  
                        <div class="input-group">
                            ...
                            <input id="campoemail" maxlength="100" type="text" value="${email}" name="email" class="form-control erro" placeholder="E-mail">
                            <span class="glyphicon remove glyphicon-remove form-control-feedback"></span>
                        </div>
                    </c:when>    
                    <c:otherwise>
                        <div class="input-group">
                            <span class="input-group-addon"><span class="fa fa-envelope fa-fw"></span></span>
                            <input id="campoemail" maxlength="100" type="text" value="${email}" name="email" class="form-control" placeholder="E-mail">
                            <c:if test="${trueEmail}">
                                <span class="glyphicon ok glyphicon-ok form-control-feedback"></span>
                            </c:if>
                        </div>
